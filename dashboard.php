...
<body>
<div class="container app-shell with-sidebar">
    <aside class="sidebar">
        <div>
        ...
        <nav class="sidebar-nav" aria-label="Navegação principal">
            <a class="sidebar-link active" href="dashboard.php">Dashboard</a>
            <a class="sidebar-link" href="contas.php">Contas a pagar</a>
        </nav>
    ...
    <main class="content-panel">
        ...
        <p class="meta">Confira o resumo das contas da sua casa.</p>
